        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 border bg-light" style="height: 100%">
                ...
                <hr>
                @if($DetailPengaduan->status_pengaduan == 6)
                    @foreach($TrhPengaduan as $TrhPengaduan)
                          @if($TrhPengaduan->status_pic == 1 || $TrhPengaduan->status_pic == 2)
                          <div class="row">
                                <div class="col-md-3">
                                </div> 
                                <div class="col-md-6 text-center">
                                  <a href="{{ action('App\Http\Controllers\KapusController@PengaduanDitindaklanjuti') }}" class="btn btn-secondary">Kembali</a>
                    ...
                    <thead>
                        ...
                        <tr>
                          ...
                          @if($PIC->status_pic == 1 || $PIC->status_pic == 2)
                            <td><button type="button" class="btn btn-warning">{{$PIC->ket_status_pic}}</button></td>
                            @elseif($PIC->status_pic == 3)
                            <td><button type="button" class="btn btn-success">{{$PIC->ket_status_pic}}</button></td>
                            @elseif($PIC->status_pic == 4)
                            <td><button type="button" class="btn btn-danger">{{$PIC->ket_status_pic}}</button></td>
                          @endif
                          <td>{{date('d M Y H:i', strtotime($PIC->created_at))}}</td>
                          <td>{{date('d M Y H:i', strtotime($PIC->kapus_updated_at))}}</td>
                        </tr>
                        </tbody>
                      @endforeach
                  </table>
                    ...
                    <div class="modal fade" id="ModalHasilTindakLanjut" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <form class="form-prevent" action="{{ action('App\Http\Controllers\KapusController@AddTindaklanjut') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                              <div class="form-group">
                                  ...
                                  <select class="form-control form-select" name="status_tindaklanjut" id="status_tindaklanjut">
                                    @foreach($mstr_status_pic as $mstr_status_pics)                                      
                                      <option value="{{ $mstr_status_pics->id_status_pic }}" {{$TrhPengaduan->status_pic == $mstr_status_pics->id_status_pic  ? 'selected' : ''}}>{{ $mstr_status_pics->keterangan}}</option>
                                    @endforeach
                                  </select>
                              </div>
                              <div class="form-group">
                                ...
                                <!-- <label style="color:red"><b>*Mohon untuk mengisi detail tindak lanjut</b></label> -->
                                <input name="idt_penanggungjawab" type="text" class="form-control" id="idt_penanggungjawab" value="{{ $TrhPengaduan->idt_penanggungjawab}}" hidden>
                                <input name="mstr_pengaduan_id" type="text" class="form-control" id="id" value="{{ $TrhPengaduan->mstr_pengaduan_id}}" hidden>
                              </div>
