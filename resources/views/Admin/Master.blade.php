...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <a href="{{ action('App\Http\Controllers\AdminController@HomeAdmin') }}" class="logo"><img src="{{asset('assets/img/bpkp.png')}}" alt=""></a>
      <h1 class="logo">Pusat Pembinaan Jabatan Fungsional Auditor<span>.</span></h1>

      <nav id="navbar" class="navbar">
        <ul>
          </li>
          <li><a href="{{ action('App\Http\Controllers\LoginAdminController@logout') }}" class="nav-link">LOG OUT</a></li>
        </ul>
      </nav><!-- .navbar -->
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      ...
      <h2>{{request()->session()->get('namalengkap')}} - Admin</h2>
