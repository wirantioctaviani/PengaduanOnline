        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 border bg-light" style="height: 100%">
                ...
                <hr>
                @if($DetailPengaduan->status_pengaduan == 8)
                    @foreach($TrhPengaduan as $TrhPengaduan)
                          ...
                          <div class="row">
                                ...
                                <div class="col-md-6 text-center">
                                  <a href="{{ action('App\Http\Controllers\SubkoorController@PengaduanDitindaklanjuti') }}" class="btn btn-secondary">Kembali</a>
                  ...
                  <table id="example2" class="table table-bordered table-striped text-center">
                    <thead>
                        ...
                        <tr>
                          ...
                          <td>{{date('d M Y H:i', strtotime($PIC->subkoor_updated_at))}}</td>
                        </tr>
                        </tbody>
                      @endforeach
                  </table>
                    ...
                    <div class="modal fade" id="ModalHasilTindakLanjut" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <form class="form-prevent" action="{{ action('App\Http\Controllers\SubkoorController@AddTindaklanjut') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                              ...
                              <div class="form-group">
                                ...
                                <input name="idt_pic" type="text" class="form-control" id="id" value="{{ $TrhPengaduan->idt_subkoordinator}}" hidden>
