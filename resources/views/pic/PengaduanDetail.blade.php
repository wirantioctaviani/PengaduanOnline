            ...
            <div class="col-md-12 border bg-light" style="height: 100%">
                ...
                <hr>
                        <div class="row">
                          <div class="col-md-1"></div>
                          <div class="col-md-10">
                            <label style="color:black;font-size: 28px;"><b><u>TINDAK LANJUT #{{ $subbid->subbid_id }}</u></b></label>
                          </div>
                          <div class="col-md-1"></div>
                        </div>
                ...
                <div class="row">
                            ...
                            <div class="col-md-6 text-center">
                              <a href="{{ action('App\Http\Controllers\PicController@PengaduanSelesai') }}" class="btn btn-secondary">Kembali</a>
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="" method="POST" enctype="multipart/form-data">
                              ...
                              @endforeach
                                <div class="form-group">
                                    <label for="exampleInputEmail1" class="form-label"><b>Dokumen Pendukung yang akan ditampilkan</b></label>
                                    <br/>
