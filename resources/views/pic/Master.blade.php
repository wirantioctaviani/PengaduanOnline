...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo"><img src="{{asset('assets/img/bpkp.png')}}" alt=""></a>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      ...
      <h2>{{request()->session()->get('namalengkap')}} - Pegawai</h2>
...
<!--     <script>
    ...
    <script>
      function terms_changed2(termsCheckBox){
          ...
          if(termsCheckBox.checked){
              //Set the disabled property to FALSE and enable the button.
              document.getElementById("inlineCheckbox21").disabled = false;
              document.getElementById("inlineCheckbox22").disabled = false;
          } else{
              //Otherwise, disable the submit button.
              document.getElementById("inlineCheckbox21").disabled = true;
              document.getElementById("inlineCheckbox22").disabled = true;
          }
      }
    </script>
    <script>
      function terms_changed3(termsCheckBox){
          ...
          if(termsCheckBox.checked){
              //Set the disabled property to FALSE and enable the button.
              document.getElementById("inlineCheckbox31").disabled = false;
              document.getElementById("inlineCheckbox32").disabled = false;
          } else{
              //Otherwise, disable the submit button.
              document.getElementById("inlineCheckbox31").disabled = true;
              document.getElementById("inlineCheckbox32").disabled = true;
          }
      }
    </script>
    <script>
