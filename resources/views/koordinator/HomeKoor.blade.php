        ...
        <div class="row">
          <div class="col-lg-3 col-md-4">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              ...
              <h4 class="title text-center"><a href="{{ action('App\Http\Controllers\KoorController@PengaduanBaru') }}">Pengaduan <br>Baru</a></h4>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
              ...
              <h4 class="title text-center"><a href="{{ action('App\Http\Controllers\KoorController@PengaduanDitindaklanjuti') }}">Pengaduan <br>Ditindaklanjuti</a></h4>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
              ...
              <h4 class="title text-center"><a href="{{ action('App\Http\Controllers\KoorController@PengaduanDiproses') }}"><i>Monitoring</i> <br>Pengaduan</a></h4>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
              ...
              <h4 class="title text-center"><a href="{{ action('App\Http\Controllers\KoorController@PengaduanSelesai') }}">Pengaduan <br><i>Closed</i></a></h4>
